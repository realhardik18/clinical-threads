...
export default function TweetCard({ tweet, onTagClick }) {
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {tweet.tags.map((tag) => (
                  <Badge 
                    key={tag} 
                    variant="outline" 
                    className="text-xs bg-black hover:bg-white/10 border-white/50 text-white opacity-[.95]"
                  >
                    #{tag}
                  </Badge>
                ))}
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {tweet.tags.map((tag) => (
                  <Badge 
                    key={tag} 
                    variant="outline" 
                    className="text-xs bg-black hover:bg-white/10 border-white/30 text-white"
                  >
                    #{tag}
                  </Badge>
                ))}
